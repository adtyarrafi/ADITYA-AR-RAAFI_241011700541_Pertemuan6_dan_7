...
class _ProfilePageState extends State<ProfilePage> {
  ...
  String email = 'adtyarrafi@gmail.com';
  String phone = '+62 85694272802';
  String birthday = 'November 07, 2005';
  ...
  void _updateProfile(Map<String, dynamic> updatedData) {
    setState(() {
      // 1. Update data teks dengan pengecekan null
      ...
      // Menggunakan kurung kurawal {} untuk menghilangkan garis biru/warning
      ...
      // 2. LOGIKA UPDATE FOTO (Paling Penting)
      // Kita harus sinkron: jika pakai file baru, URL harus dikosongkan (dan sebaliknya)
      if (updatedData['avatarFile'] != null) {
        avatarFile = updatedData['avatarFile'];
        avatarUrl = null; // Reset URL agar FileImage yang tampil
      } else if (updatedData['avatarUrl'] != null) {
        avatarUrl = updatedData['avatarUrl'];
        avatarFile = null; // Reset File agar NetworkImage yang tampil
      }

      // 3. Paksa clear cache agar gambar langsung berubah
      imageCache.clear();
  ...
  ImageProvider _getAvatarImage() {
    if (avatarFile != null) {
      ...
      return const NetworkImage('ganteng.jpeg');
    }
  }
